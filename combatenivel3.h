...
private:
    ...
    QGraphicsRectItem *leftTrigger_  = nullptr;
    QGraphicsRectItem *rightTrigger_ = nullptr;
    ...
    QRectF walkPrc_  = QRectF(0.05, 0.47, 0.90, 0.42);
    QRectF leftPrc_  = QRectF(0.25, 0.46, 0.10, 0.20);
    QRectF rightPrc_ = QRectF(0.70, 0.46, 0.10, 0.20);
};
